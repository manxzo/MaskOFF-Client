...
| POST        | sendFriendReq          | `/api/friends/request`                | **200:** Friend request sent<br>**400:** Missing **friendID** or request already sent<br>**404:** Target user not found<br>**500:** Server error   | `{ "friendID": "userId" }`                                                    | Send a friend request                                                     | Implemented  |
| DELETE      | deleteFriendRequest    | `/api/friends/request`                | **200:** Friend request canceled/declined successfully<br>**400:** Missing **friendID** or no pending request<br>**404:** Target user not found<br>**500:** Server error | `{ "friendID": "userId" }`                                                    | Cancel/decline a pending friend request                                   | Implemented  |
...
| POST        | acceptFriend           | `/api/friends/accept`                 | **200:** Friend request accepted<br>**400:** Missing **friendID** or no friend request<br>**500:** Server error                                      | `{ "friendID": "userId" }`                                                    | Accept a friend request                                                   | Implemented  |
